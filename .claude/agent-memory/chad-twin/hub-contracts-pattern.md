...
**How to apply:** after editing `state_aggregator.types`, run `python3 packages/hub-contracts/codegen.py`
or the drift guard fails. Guards: `test_hub_contracts_drift.py` (pydantic validates golden fixture +
